...
class SaleAdvancePaymentInv(models.TransientModel):
    ...
    def _onchange_dates(self):
        if self.init_date_invoice and self.end_date_invoice:
            init = fields.Date.from_string(self.init_date_invoice)
            end = fields.Date.from_string(self.end_date_invoice)
            if end < init:
    ...
    def create_invoices(self):
        ...
        date_init = fields.Date.from_string(self.init_date_invoice)
        date_end = fields.Date.from_string(self.end_date_invoice)
        sale_orders.write({

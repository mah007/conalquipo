...
##############################################################################
{
    ...
    'depends': ['base', 'crm', 'project', 'delivery', 'hr_timesheet',
                'sale_timesheet', 'sale', 'purchase', 'stock',
                'stock_real_availability', 'con_client_code',
                'con_project_works', 'con_project_translates',
                'con_project_stock', 'con_sale', 'con_shipping',
